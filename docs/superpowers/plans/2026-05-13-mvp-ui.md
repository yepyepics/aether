...
**Goal:** Build the visual MVP screen for Aether — URL input, format/quality selectors, folder picker row, download button, and progress card — as a pure SolidJS UI mockup with no Rust/yt-dlp logic.
...
- [ ] Top bar shows "Aether" + version badge + ⚙ icon
